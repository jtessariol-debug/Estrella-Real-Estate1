...
export default function Footer() {
  return <footer className="footer"><div className="container"><div className="footer-grid">
    <div className="footer-brand-column"><a className="logo footer-brand" href="/" aria-label="Estrella Real Estate, inicio"><BrandLogo className="footer-brand-logo" /></a><p className="footer-description">Propiedades seleccionadas y acompañamiento inmobiliario en República Dominicana.</p><p className="footer-location">{COMPANY_INFO.location}</p></div>
